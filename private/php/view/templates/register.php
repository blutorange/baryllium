...
<form novalidate method="post" data-bootstrap-parsley action="<?= $this->e($action) ?>">
    <?php $this->insert('partials/form/input', ['label' => $this->gettext('register.username'),
        'name' => 'username', 'required' => true,
        'placeholder' => $this->gettext('register.username.hint')]) ?>
    
     <?php $this->insert('partials/form/input', ['label' => $this->gettext('register.firstname'),
        'name' => 'firstname', 'required' => false,
        'placeholder' => $this->gettext('register.firstname.hint')]) ?>
    
        <?php $this->insert('partials/form/input', ['label' => $this->gettext('register.lastname'),
    ...
    <?php $this->insert('partials/form/input', ['label' => $this->gettext('register.pass'),
        ...
        <?php $this->insert('partials/form/checkbox', ['label' => $this->gettext('register.agb'),
